  ...
  return {
    ...
    questions: [
      ...
      },
      {
        ...
        description:"Does the customer have a plan for remodeling?",
        choices:[
          {
          ...
          },
          {
            ...
            value:"No existing plan, needs design suggestions"
          },
          {
            label:"Already have a plan, just need installation",
            value:"Already has a plan, just needs installation"
          }
        ]
      },
      {
        field_type:"checklist",
        question:"What bathroom furniture and fixtures will you be replacing?",
        description:"Bathroom furniture customer wants to replace",
        choices:[
          {
          ...
          {
            label:"Sink faucet/Tub faucet/shower-head",
            value:"Sink faucet/Tub faucet/shower-head"
          },
          {
            can_describe:true
          }
