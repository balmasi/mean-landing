module.exports = function(parentId) {
  return{
        ...
        questions: [
        {
                ...
                describtion:"Water heater services needed by the customer",
                choices:[
                {
        ...
        },
        {
                ...
                describtion:"Heater problems that customer is experiencing",
                choices:[
                {
                        label:"Leaks",
                        value:"Leaks"
                ...
                {
                        label:"Unsual noises from inside heater",
                        value:"Unsual noises from inside heater"
                },
                {
        ...
        }
        {
                ...
                describtion:"Single heater building",
                choices:[
                {
                        label:"Yes",
                        value:"Yes"
        ...
        },
        {
                ...
                describtion:"There is a tank or not",
                choices:[
                {
                        label:"Yes",
                        value:"Yes"
        ...
        
        {
                ...
                describtion:"If the boilder and water heater combined or not",
                choices:[
                {
